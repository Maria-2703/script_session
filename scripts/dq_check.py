#!/usr/bin/env python3
"""
Data Quality Gate simple para CSVs de encuestas (Alcoi).
- Lee CSV y reglas YAML.
- Mapea nombres reales -> cannicos.
- Fuerza tipos.
- Ejecuta checks y guarda informe CSV.
- Exit code: 0 (OK) / 1 (errores crticos).
"""
...
def main():
    ...
    if has_errors:
        logging.error("Errores crticos detectados. Abortando (exit=1).")
        sys.exit(1)
    else:
